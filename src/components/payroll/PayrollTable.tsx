          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {isAdmin && (
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-odoo-800 to-odoo-700 hover:from-odoo-700 hover:to-odoo-600 text-white text-xs font-bold shadow-md shadow-odoo-800/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
                ...
                filteredRecords.map(record => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap font-semibold text-slate-900 dark:text-white font-mono">
                        ${record.grossSalary.toLocaleString()}
                      </td>

                      <td className="px-6 py-4 whitespace-nowrap font-semibold text-rose-600 dark:text-rose-400 font-mono">
                        -${record.totalDeductions.toLocaleString()}
                      </td>

                      <td className="px-6 py-4 whitespace-nowrap font-extrabold text-emerald-600 dark:text-emerald-400 font-mono text-sm">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <button
                            ...
                            className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-teal-50 hover:bg-teal-100 dark:bg-teal-950/40 dark:hover:bg-teal-900/50 text-teal-700 dark:text-teal-300 font-semibold text-[11px] transition-colors"
                          >
                          ...
                          {isAdmin && emp && (
                            <button
                              ...
                              className="p-1.5 rounded-lg bg-odoo-50 hover:bg-odoo-100 dark:bg-odoo-950/40 dark:hover:bg-odoo-900/50 text-odoo-700 dark:text-odoo-300 transition-colors"
                            >
